    ...
    <SectionRegister>
      <RegisterBox>
        <RegisterForm action="#">
          ...
          <FormGroupContainer>
            <FormGroup>
              ...
              <FormInput
                ...
                id="email"
                required
                onChange={(e) => handleSetFeild(e.target.value, 'email')}
              />
            </FormGroup>
            ...
            <FormGroup>
              ...
              <FormInput
                ...
                id="fullName"
                required
                onChange={(e) => handleSetFeild(e.target.value, 'fullName')}
              />
            </FormGroup>
          </FormGroupContainer>
          ...
          <FormGroupContainer>
            <FormGroup>
              ...
              <FormInput
                ...
                id="age"
                required
                onChange={(e) => handleSetFeild(e.target.value, 'age')}
              />
            </FormGroup>
          ...
          <LoginLink to="/">برای ورود کلیک کنید</LoginLink>
        </RegisterForm>
      </RegisterBox>
      <FooterRegister>
        <FooterRegisterText>
          Built by{' '}
          <FooterRegisterLink href="#">Zahra Alipour</FooterRegisterLink>.
