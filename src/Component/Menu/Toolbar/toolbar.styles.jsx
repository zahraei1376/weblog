...
export const ArrowIconButton = styled(IconButton)`
  // color:#fff;
  color: ${(props) => (props.close ? '#000 !important' : ' #fff !important;')};
  // font-size:2.5rem;
  width: 3rem !important;
  height: 3rem !important;
  border-radius: 5px !important;
  align-self: ${(props) => (props.close ? 'end;' : 'start')};
  margin: ${(props) => (props.close ? '1rem !important' : '1rem 0')};
  // margin: 1rem 0;
  border: ${(props) =>
    props.close ? '1px solid #000 !important;' : '1px solid #fff !important;'};
...
export const ArrowCloseIcon = styled(KeyboardArrowRightIcon)`
  ${IconsCss};
  color: #000;
  font-size: 2.5rem !important;
`;
